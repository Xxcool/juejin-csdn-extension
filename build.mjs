...
await Promise.all(['manifest.json','rules.json','LICENSE','assets/logo.svg','assets/logo-16.png','assets/logo-32.png','assets/logo-48.png','assets/logo-128.png','src/popup.html','src/popup.css','src/juejin-content.css'].map(async file => fs.copyFile(file, `dist/${file.split('/').pop()}`)));
